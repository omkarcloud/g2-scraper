...
The first 400 products are generously free to scrape with the API. After that, you can upgrade to the Pro Plan to scrape 1,000 products for $4, which is a really great price, considering that the data is 101% accurate, fresh, and comprehensive with 45+ fields.
